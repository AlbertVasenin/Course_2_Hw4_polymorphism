...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    printInfo(lada, kia, skoda, mazda, kamaz, kamazTwo, kamazThree, kamazFour, bau, paz, jac, vdl);
    separator();
    ...
    printAuto(lada, kia, skoda, mazda, kamaz, kamazTwo, kamazThree, kamazFour, bau, paz, jac, vdl);
